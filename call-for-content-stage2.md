...
### Tutorials
For your next submission as a tutorial, we would like an annotated lesson plan of no more than 5 pages which includes:
 ...
 *  List of session objectives (e.g.. by the end of this session, attendees will be able to…)  
 *  Motivation, or an explanation of why these objectives are important (e.g. this concept is increasingly important in the field of travel analysis because…..)  
 *  Moderator and their role in the session  
 *  Session Assistant and their role in the session (e.g. loading slides, passing the mic)
 *  Anticipated Panelists (including diversity of affiliation/perspective)
Session time plan, or how you plan to use ~90 minutes  
 *  Description of each session segment listed in your time plan, including participants, content that will be presented or discussed, references, and attendee participation methods  
 *  Plan for how the session will create lasting positive impact in the travel analysis community    

### Spark Selection

Your submission has been accepted topically and is anticipated to be presented in an interactive session, lightning talk or interactive poster session.  For your next submission in this category, we would like an extended abstract of three-to-five pages that expands on the topic and addresses feedback from reviewers.
